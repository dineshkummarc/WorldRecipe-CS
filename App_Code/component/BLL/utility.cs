...
#region A to Z Alphabet Letter Links
        /// <summary>
        /// Display A to Z Alphabet link
        /// </summary>
        public static string DisplayAZAlphabetLink(int flag)
        {
            ...
            switch (flag) 
            {
                case constant.UserFrontEnd: //Show a-z link for the front-end
                    for (i = 65; i <= 90; i++)
                    {
                        strLetter = strLetter + "<a href=\"recipename.aspx?letter=" + (char)(i)
                                    + '"' + "class=\"letter\" title=" + "Browse&nbsp;recipe&nbsp;starting&nbsp;with&nbsp;letter&nbsp;"
                                    + (char)(i) + ">" + (char)(i) + "</a>  ";
                    }
                    break;

                case constant.AdminBackEnd: //Show a-z link for the admin recipemanager
                    for (i = 65; i <= 90; i++)
                    {
                        strLetter = strLetter + "<a href=\"recipemanager.aspx?l=" + (char)(i)
                                      + '"' + "class=\"dlet\" title=" + "Browse&nbsp;recipe&nbsp;starting&nbsp;with&nbsp;letter&nbsp;"
                                      + (char)(i) + ">" + (char)(i) + "</a>  ";
                    }
                    break;
            }
